//! Implementation of `Drawer` for SVG output
//!
//! Heavily borrowed from `piet-svg`.

mod text;

use std::{borrow::Cow, fmt, fmt::Write, io, mem};

use crate::draw::{Color, FixedGradient};
use image::{DynamicImage, GenericImageView, ImageBuffer};
use kurbo::{Affine, Point, Rect, Shape, Size};
use piet::{
    Error, FixedGradient, FontStyle, Image, ImageFormat, InterpolationMode, IntoBrush, LineCap,
    LineJoin, StrokeStyle, TextAlignment, TextLayout as _,
};
use svg::node::Node;

pub use text::{Text, TextLayout};
